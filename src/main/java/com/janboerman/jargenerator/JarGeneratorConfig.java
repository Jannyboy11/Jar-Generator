...
public interface JarGeneratorConfig extends Config {
    ...
    @ConfigItem(keyName = "unknownChargesColour", name = "Unknown colour", description = "Configures the text colour when the amount of charges is not exactly known", position = 2)
